...
export const QUESTIONS = [
    { 
        text: "When the drums of war beat, how do you answer?", 
        options: [
            { text: "With overwhelming force and fury.", tags: ["Aggressive", "Attack", "Battle", "Blood", "Charge", "Combat", "Fury", "Hit", "Kill", "Rage", "Rage-fueled", "Strike", "Violence", "Visceral", "War", "Wound"] },
            { text: "I stand as a bulwark for the weak.", tags: ["Defense", "Guard", "Protect", "Protection", "Shield", "Ward"] },
            { text: "With the precision of my chosen arms.", tags: ["Blade", "Break", "Crush", "Cudgel-bearer", "Forked-spear", "Greatlance", "Lance", "Longaxe", "Mace-wielder", "Old-hammer", "Pike-wielder", "Sharp", "Spike", "Sword", "Weapon"] },
            { text: "I hunt the enemy down like prey.", tags: ["Champion", "Competition", "Fight", "Hunt", "Hunter", "Pain", "Predator", "Punish", "Punitive", "Reach", "Scavenge", "Trap"] }
        ]
    },
    { 
        text: "Which aspect of the wild calls to your soul?", 
        options: [
            { text: "The deep, tangled forests and growing things.", tags: ["Arboreal", "Branch-wielder", "Foliage-clad", "Forest", "Green", "Grow", "Growth", "Leaf", "Moss", "Nature", "Root", "Sylvan", "Tree", "Wood", "Wild"] },
            { text: "The unyielding stone and dark places beneath.", tags: ["Cave", "Dust", "Earth", "Ground", "Metal", "Mud", "Rot", "Sand", "Stone", "Underground"] },
            { text: "The crashing waves and thundering skies.", tags: ["Cloud", "Mire", "Ocean", "Rain", "River", "Sea", "Storm", "Swamp", "Thunder", "Water", "Wet"] },
            { text: "The extremes of heat and cold.", tags: ["Air", "Ash", "Cold", "Dry", "Fire", "Freeze", "Heat", "Ice", "Light", "Salt", "Sky", "Snow", "Wind", "Winter"] }
        ]
    },
    { 
        text: "What is your role within the walls of the City?", 
        options: [
            { text: "I command and lead the people.", tags: ["Authority", "Command", "Commanding", "Crown", "Decree", "Duty", "King", "Law", "Leader", "Leadership", "Noble", "Order", "Power", "Rule", "Ruler"] },
            { text: "I enjoy the finery and status of my station.", tags: ["Fame", "Glory", "Gold", "Heraldic", "Heraldry", "Honor", "Hospitality", "Luxury", "Money", "Opulent", "Rich", "Social", "Wealth"] },
            { text: "I build and defend the structures of society.", tags: ["Brick", "Building", "City", "Civilization", "Community", "House", "Structure", "Urban", "Wall"] },
            { text: "I operate in the shadows or margins.", tags: ["Court", "Crime", "Crowd", "Jailor", "Judge", "Justiciar", "Liberty", "Market", "Merchant", "Party", "Poor", "Prison", "Rustic", "Service", "Slave", "Thief", "Trade", "Work"] }
        ]
    },
    { 
        text: "What lies beyond the veil of the mundane?", 
        options: [
            { text: "The cold embrace of the grave.", tags: ["Bone", "Dead", "Death", "Ghost", "Grave", "Grim", "Pale-steed", "Skeleton", "Skull", "Soul", "Spirit", "Vampire"] },
            { text: "Things that should not be known.", tags: ["Alien", "Ancient", "Chaos", "Demon", "Monster", "Mutant", "Mystery", "Void"] },
            { text: "The power of spells and secrets.", tags: ["Magic", "Miracle", "Myth", "Omen", "Portal", "Ritual", "Rune", "Sacred", "Secret", "Spell", "Witch", "Wizard"] },
            { text: "The shifting forms of night.", tags: ["Dark", "Dream", "Fade", "Fate", "Hallow", "Hidden", "Holy", "Hooded-steed", "Illusion", "Memory", "Night", "Phantom", "Shadow", "Spotted-steed", "Tattered-steed", "Tattooed-steed", "Vision"] }
        ]
    },
    { 
        text: "How do you perceive the truth?", 
        options: [
            { text: "Through books, scrolls, and study.", tags: ["Book", "History", "Ink", "Learn", "Lore", "Read", "Scholar", "School", "Scroll", "Study", "Word", "Write"] },
            { text: "Through logic, planning, and reason.", tags: ["Fact", "Focus", "Logic", "Mind", "Plan", "Reason", "Skill", "Smart", "Strategist", "Theory", "Think", "Thought"] },
            { text: "By asking questions and seeking answers.", tags: ["Curious", "Discovery", "Idea", "Know", "Knowledge", "Puzzle", "Riddle", "Tale", "Story"] },
            { text: "I know what is true and hold to it.", tags: ["Belief", "Clever", "Dogmatic", "Doubt", "Doubtful", "Teach", "Truth", "Truth-bound", "Wisdom", "Wise"] }
        ]
    },
    { 
        text: "What is your preferred method of solving a problem?", 
        options: [
            { text: "I build, forge, or cook a solution.", tags: ["Build", "Construct", "Cook", "Craft", "Create", "Fix", "Make", "Mold", "Repair", "Weave", "Web", "Work"] },
            { text: "I move, run, or climb to overcome it.", tags: ["Climb", "Flight", "Fly", "Go", "Jump", "Move", "Run", "Swim", "Walk", "Walking"] },
            { text: "I control, trick, or steal what I need.", tags: ["Access", "Bind", "Catch", "Change", "Control", "Copy", "Cut", "Grab", "Hide", "Hold", "Open", "Pull", "Push", "Steal", "Swap", "Take", "Touch"] },
            { text: "I watch and wait for the right moment.", tags: ["Act", "Call", "Carry", "Chew", "Collect", "Dig", "Drink", "Eat", "Look", "Play", "Seek", "Showman", "Sleep", "Speak", "Stop", "Wait", "Watch"] }
        ]
    },
    { 
        text: "What feeling burns brightest within you?", 
        options: [
            { text: "Courage, honesty, and duty.", tags: ["Brave", "Dutiful", "Honesty", "Hope", "Love", "Mercy", "Modesty", "Peace", "Resilience", "Respect", "Trust", "Valour", "Vigilance"] },
            { text: "Anger, fear, and regret.", tags: ["Angry", "Apathy", "Cruel", "Cruelty", "Fear", "Gloom", "Greed", "Hate", "Lonely", "Loner", "Mad", "Melancholy", "Paranoid", "Petulant-steed", "Regret", "Sad", "Stern", "Vengeance"] },
            { text: "Joy, pride, and determination.", tags: ["Determination", "Elegance", "Fun", "Happy", "Impetuosity", "Intoxicated", "Joy", "Passion", "Pride", "Prideful", "Warmth", "Wonder"] },
            { text: "Quiet patience and introversion.", tags: ["Calm", "Empathetic", "Gentle", "Introversion", "Patience", "Quiet", "Serious", "Simple", "Stubborn"] }
        ]
    },
    { 
        text: "Which object holds the most significance to you?", 
        options: [
            { text: "Fine jewelry, coins, and silks.", tags: ["Coin", "Gem", "Gold", "Ring", "Silk", "Silver", "Treasure"] },
            { text: "Practical tools, keys, and maps.", tags: ["Bag", "Bottle", "Box", "Clock", "Key", "Lamp", "Lock", "Map", "Oil", "Paper", "Pen", "Rope", "Sack", "String", "Tool", "Wheel"] },
            { text: "Armor, shields, and weapons.", tags: ["Armor", "Chain", "Coat", "Iron", "Shield", "Steel", "Whip"] },
            { text: "Strange relics and bones.", tags: ["Bell", "Bone", "Cloth", "Cup", "Door", "Glass", "Kite", "Mask", "Mirror", "Nail", "Shell", "Ship", "Skin", "Skull", "Tankard", "Toy", "Vault"] }
        ]
    },
    { 
        text: "Which beast do you feel a kinship with?", 
        options: [
            { text: "The hunters: wolves, lions, and hawks.", tags: ["Beast", "Cat", "Dog", "Fox", "Hawk", "Hound", "Lion", "Owl", "Pack", "Tiger", "Wolf"] },
            { text: "The masters of the sky.", tags: ["Bird", "Dove", "Feather", "Gull", "Magpie", "Pigeon", "Raven", "Vulture"] },
            { text: "The crawling, swarming multitudes.", tags: ["Bug", "Hive", "Insect", "Rat", "Serpent", "Snake", "Spider", "Swarm", "Vermin", "Worm"] },
            { text: "The loyal mounts and noble creatures.", tags: ["Animal", "Beast-bond", "Bestial", "Fish", "Horse", "Majestic-charger", "Mule", "Noble-steed", "Stocky-steed", "Turtle"] }
        ]
    },
    { 
        text: "How do you perceive your journey through life?", 
        options: [
            { text: "A fast, frantic race.", tags: ["Fast", "Haste", "Quick", "Run", "Speed", "Swift"] },
            { text: "A long, wandering road.", tags: ["Distance", "Far", "Journey", "Path", "Quest", "Ride", "Road", "Track", "Trail", "Transient", "Travel", "Wander", "Wanderer", "Wayfinder"] },
            { text: "The turning of seasons and ages.", tags: ["Age", "Cycle", "Day", "End", "Future", "Hour", "Late", "Life", "Moment", "Month", "Morning", "Now", "Old", "Past", "Season", "Time", "Today", "Tomorrow", "Year", "Young", "Youth"] },
            { text: "Where I stand right now.", tags: ["Beginning", "Chance", "Circle", "High", "Infinite", "Low", "Return", "Slow", "Space", "Start", "Steady"] }
        ]
    },
    { 
        text: "What sensation dominates your world?", 
        options: [
            { text: "Bright lights and clear visions.", tags: ["Beauty", "Blind", "Bright", "Clear", "Color", "Gaze", "Invisible", "Light", "Look", "Observe", "Perception", "Perspective", "Reflection", "See", "Sharp", "Shine", "Shiny", "Sight", "Spy", "View", "Watcher"] },
            { text: "Loud noises and whispers.", tags: ["Deaf", "Echo", "Hear", "Listen", "Loud", "Noise", "Quiet", "Silent", "Sound", "Voice", "Voice-shout", "Whisper"] },
            { text: "The texture and weight of things.", tags: ["Hard", "Heavy", "Rough", "Smooth", "Soft", "Texture", "Touch", "Weight"] },
            { text: "Subtle scents and tastes.", tags: ["Scent", "Smell", "Taste"] }
        ]
    },
    { 
        text: "Which part of yourself do you trust most?", 
        options: [
            { text: "My eyes, ears, and mouth.", tags: ["Ear", "Eye", "Face", "Head", "Jaw", "Mouth", "Nose", "Teeth", "Throat", "Tongue", "Tooth"] },
            { text: "My hands and strength.", tags: ["Arm", "Finger", "Hand", "Limb", "Muscle"] },
            { text: "My heart and breath.", tags: ["Blood", "Breath", "Flesh", "Heart", "Lung", "Vein"] },
            { text: "My bones and feet.", tags: ["Back", "Body", "Bone", "Foot", "Hair", "Leg", "Nerve", "Rib", "Skeleton", "Skin", "Spine", "Toe"] }
        ]
    }
];
